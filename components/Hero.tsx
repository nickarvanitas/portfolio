...
export default function Hero() {
  ...
  return (
    <div className='h-[calc(100vh-4rem)] relative grid grid-rows-[1fr_auto_1.2fr] lg:grid-rows-[1fr_auto] lg:grid-cols-2' onMouseOut={() => setIsHovering(false)} onMouseOver={() => setIsHovering(true)}>
      <div className='px-4 md:px-6 lg:px-12 flex items-center dark:bg-gradient-radial dark:from-zinc-950 dark:to-zinc-800 row-span-1 lg:col-span-1 lg:col-start-1 lg:row-start-1'>
      ...
      <HeroExperience className='row-span-1 lg:col-start-2 lg:row-start-1' />
      <div className='relative z-[5] row-start-2'>
        <div className='flex  scrollbar-hide scroll- w-[100vw] scroll space-x-2 bg-zinc-900 py-2 lg:py-6 border-t-2 border-b-2 border-zinc-600'>
