    ...
    <footer className="bg-zinc-950">
      <div className="max-w-screen-xl px-4 py-8 mx-auto space-y-8 overflow-hidden sm:px-6 lg:px-8">
        ...
        <div className="flex justify-center mt-8 space-x-6">
          ...
          <a href="https://www.linkedin.com/in/narvanitas" className="text-zinc-400 hover:text-zinc-300 transition-default" target={'blank'}>
      ...
      <div>
        <p className="py-2 px-4 text-base leading-6 text-center border-t border-t-zinc-500 text-zinc-500 flex flex-start">
