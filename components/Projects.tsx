  ...
  return (
    <div ref={containerRef}>
      <div className="scroll-container sticky inset-0 will-change-transform bg-zinc-800 border-b-2 border-zinc-500 z-[5]">
        ...
        >
          <div className="relative block py-16 px-4 lg:my-0 whitespace-nowrap overflow-auto lg:overflow-visible lg:whitespace-normal lg:flex lg:gap-x-40 xl:px-40 lg:px-30" >
            {projects.map((project, i) => (
              <a href={project.href} className="inline-block whitespace-normal mr-8 last-of-type:mr-0 lg:block w-[calc(80vw)] md:w-[80vw] lg:w-[40vw] 2xl:w-[30vw] aspect-[4/5] md:aspect-[3/2] lg:aspect-square group border-zinc-500 border-2 relative overflow-hidden px-7 py-9 bg-zinc-950 shadow-2xl" key={project.href}>
                <div className='flex flex-col '>
                  <div className='!leading-tighter text-5xl lg:text-5xl xl:text-7xl text-white font-bold  pb-4'>{project.title}</div>
                  <div className=' text-zinc-400 font-light text-base md:text-xl lg:text-2xl'>{project.subtitle}</div>
                </div>
                ...
                <div className="absolute bottom-2 right-3 lg:text-4xl text-lg z-[1] group-hover:text-white text-transparent font-serif" style={{ WebkitTextStroke: '1px', WebkitTextStrokeColor: 'white' }}>0{i + 1}</div>
