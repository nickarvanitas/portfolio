...
<Wrapper gridWidth={4}>
  <Container width={1} bgColor={"#F8F9FA"}>
    <ColorBlock color={"black"}>#F8F9FA</ColorBlock>
  </Container>
  <Container width={1} bgColor={"#F2813A"}>
    <ColorBlock color={"black"}>#F2813A</ColorBlock>
  </Container>
  <Container width={1} bgColor={"#A7A8AB"}>
    <ColorBlock color={"black"}>#A7A8AB</ColorBlock>
  </Container>
  <Container width={1} bgColor={"#4D6594"}>
    <ColorBlock color={"white"}>#4D6594</ColorBlock>
  </Container>
</Wrapper>
...
### Whiteboarding ![Whiteboard](/mtc/whiteboard.jpg "title") > Photo credit to Kaleidico
on Unsplash
