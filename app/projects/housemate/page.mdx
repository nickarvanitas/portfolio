...
<Wrapper gridWidth={4}>
  <Container width={1} bgColor={"#34495E"}>
    <ColorBlock color={"white"}>#34495E</ColorBlock>
  </Container>
  <Container width={1} bgColor={"#E67E22"}>
    <ColorBlock color={"white"}>#E67E22</ColorBlock>
  </Container>
  <Container width={1} bgColor={"#ECF0F1"}>
    <ColorBlock color={"black"}>#ECF0F1</ColorBlock>
  </Container>
  <Container width={1} bgColor={"#F9F9F9"}>
    <ColorBlock color={"black"}>#F9F9F9</ColorBlock>
  </Container>
</Wrapper>
